            ...
            try (CloseableHttpResponse execute = client.execute(new HttpGet(url))) {
                if (execute.getStatusLine().getStatusCode() == 200) {
                    ...
                    for (CSVRecord record : csvRecords) {
                        ...
                        order.setComplaintInfo(record.get(21));
                        ...
                        String qq=record.get(22);
                        String qs=record.get(21);
...
//waimaieapp.meituan.com/finance/v2/finance/orderChecking/export/download//meituan_waimai_file_bill_export-2017-10-11-1317988.xls
                ...
                try (CloseableHttpResponse execute = client.execute(new HttpGet(url))) {
                    ...
                    for (int rowNum = 1; rowNum <= sheet.getLastRowNum(); rowNum++) {
                        ...
                        if (row != null) {
                            ...
                            mtBill.setId(accountInfo.wmPoiId + "$" + mtBill.getAppNo()+"$"+mtBill.getDesc()+"$"+mtBill.getShopPrice());
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        authenticate.setUserName("hJJp92");
        authenticate.setPassword("197205a");
        ...
        // mtCrawler.bizDataReport("2017-11-27", "2017-11-27", false);
       //  mtCrawler.businessStatistics("20171101", "20171101", false);
        // mtCrawler.flowanalysis("30", false);
        //mtCrawler.hotSales("2017-07-31","2017-08-06",true);
        // mtCrawler.comment("2017-08-01", "2017-08-06", true);
          mtCrawler.historySettleBillList("2017-11-10", "2017-11-10", true);
        //mtCrawler.acts(true);
    }
}
